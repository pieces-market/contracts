...
contract MockPiecesMarketTest is Test {
    ...
    function testMockedTransactionsFlow() public {
        ...
        vm.startPrank(ADMIN);
        auctioner.create("Asset", "AST", "https:", 0.01 ether, 100, 10, block.timestamp, block.timestamp + 7 days, BROKER, 500, 50);
        vm.stopPrank();

        /// @dev OPENED AUCTION WITH BUYERS (id: 2)
        vm.startPrank(ADMIN);
        auctioner.create("Asset", "AST", "https:", 0.01 ether, 100, 10, block.timestamp, block.timestamp + 70 days, BROKER, 500, 50);
        vm.stopPrank();
        ...
        vm.startPrank(ADMIN);
        auctioner.create("Asset", "AST", "https:", 0.01 ether, 30, 10, block.timestamp, block.timestamp + 7 days, BROKER, 500, 50);
        vm.stopPrank();
