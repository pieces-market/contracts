...
import {AssetR} from "../../src/AssetR.sol";
...
contract AssetTest is Test {
    ...
    function test_defaultRoyalties() public {}

    function test_RoyaltyValue() public {}
    ...
    function testCannotDelegateVotesWithoutTokensTransfer() public {
        vm.startPrank(DEVIL);
        vm.expectRevert(AssetR.VotesDelegationOnlyOnTokensTransfer.selector);
